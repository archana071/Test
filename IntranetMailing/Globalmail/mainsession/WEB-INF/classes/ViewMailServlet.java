...
public class ViewMailServlet extends HttpServlet {
 ...
 out.println("<a href='compose?uname="+uname+"'>Write Mail</a>");
		...
		out.println("<td height=36 ><form method=post action=sendReply>");
...
out.println("</form></td>");
out.println("<td height=36 align=left><form method=post action=sendForward>");
		...
		out.println("</form></td><a href='inbox?uname="+uname+"'>Back</a> </tr>");
