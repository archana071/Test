...
public class ComposeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<title>Write Page</title>");
...
out.println("<a href='compose?uname="+uname+"'>Write Mail</a>");
		...
		out.println("<th height=34 colspan=2 bgcolor=#CCCCCC>Write Mail</th>");
		out.println("</tr>");
		out.println("<tr bgcolor=#CCCCCC> ");
		...
		out.println("<input name=subject type=text id=subject>");
		...
		out.println("<td colspan=2 bgcolor=#FFFFFF><textarea name=content cols=100 rows=20 id=content></textarea></td>");
		out.println("</tr>");
		out.println("<tr bgcolor=#CCCCCC> ");
